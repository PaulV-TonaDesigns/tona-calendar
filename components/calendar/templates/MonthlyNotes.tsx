...
export default function MonthlyNotes({
  ...
  return (
    <div style={{ boxSizing: "border-box", width: "100%", height: "100%", display: "flex", flexDirection: "column" }}>
      ...
      {/* Header */}
      <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", boxSizing: "border-box", marginBottom: 12, flexShrink: 0 }}>
      ...
      {/* Main grid */}
      <div style={{ display: "grid", gridTemplateColumns: "1fr 0.38fr", gap: 14, flex: 1, minHeight: 0 }}>

        {/* Calendar */}
        <div style={{ boxSizing: "border-box", border: "3px solid #111", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ border: "3px solid #111", display: "flex", flexDirection: "column" }}>
          <div style={{ padding: "10px 12px", borderBottom: "2px solid #111", flexShrink: 0 }}>
            <div style={{ fontSize: 12, fontWeight: 900, letterSpacing: "0.18em" }}>
              {notesTitle}
            </div>
          </div>
          <div style={{ flex: 1, padding: 12, display: "flex", flexDirection: "column", justifyContent: "space-evenly" }}>
            {Array.from({ length: 10 }).map((_, i) => (
              <div key={i} style={{ borderBottom: "1px solid #111", opacity: 0.9 }} />
            ))}
          </div>
        </div>
      ...
      {/* Footer */}
      <div style={{ marginTop: 10, flexShrink: 0, textAlign: "center", fontSize: 10, letterSpacing: "0.08em", opacity: 0.7 }}>
        {footerText}
      </div>
